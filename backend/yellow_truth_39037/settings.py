"""
Django settings for yellow_truth_39037 project.
...
ROOT_URLCONF = 'yellow_truth_39037.urls'
...
WSGI_APPLICATION = 'yellow_truth_39037.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "yellow_truth_39037 API",
    "DESCRIPTION": "API documentation for yellow_truth_39037 App",
    "VERSION": "v1",
}
